      PROGRAM INVERSE
c  SAMPLE TEST VERSION for 15 bins, see c$$ lines below
...
c >>> here you need to define your number of diameter bins, nb >>>>>>>
      INTEGER nb
c$$   special case 15 bins for comparison with published results
      PARAMETER (nb = 15)
...
c>>>> here filenames are mnemonic for size distribution parameters >>>
      PARAMETER (inputFile =
     &           'random_arith_160_160_500k_25_15bin.dat')     
      PARAMETER(outputFile=
     &           'random_arith_160_160_500k_25_15bin_out.dat')
...
c ns now has the components of the recovered number density nv.
       ...
       do i = 1,n
c$$       write (10,1000), (adup(i,j),j=1,n)
c$$ to test the code set nb = 15 and instead write the k matrix = adup/da
       write (10,1000), (adup(i,j)/da,j=1,n)
